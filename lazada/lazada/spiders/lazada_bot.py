...
class LazadaBotSpider(scrapy.Spider):
    ...
    #     'https://www.lazada.vn/products/hcmtra-gop-0mainboard-asus-z590-rog-maximus-xiii-extreme-glacial-intel-i1319131294-s5226087280.html?spm=a2o4n.home.just4u.14.19946afejQP6RT&scm=1007.17519.162103.0&pvid=df2bb7fe-57c6-47a8-b946-da3ed41bcd35&search=0&clickTrackInfo=tcsceneid%3AHPJFY%3Bbuyernid%3A7ad5fd1a-d9f1-43de-e917-fa99f2b65de9%3Btcboost%3A0%3Bpvid%3Adf2bb7fe-57c6-47a8-b946-da3ed41bcd35%3Bchannel_id%3A0000%3Bmt%3Ai2i%3Bitem_id%3A1319131294%3Bself_ab_id%3A162103%3Bself_app_id%3A7519%3Blayer_buckets%3A5437.25236_955.3630_955.7330_6059.28889%3Bpos%3A14%3B'
    #     ]
    ...
    def start_requests(self):
        ...
        'https://www.lazada.vn/products/levents-ao-thun-popular-logo-tee-black-white-i1343514476-s5521428864.html?spm=a2o4n.searchlist.list.5.371720bdJYcAKi&search=1',
        'https://www.lazada.vn/products/ao-thun-bad-rabbit-rabbies-ao-phong-form-uk-rong-tay-ngan-cotton-100-den-i1015590763-s3359398896.html?spm=a2o4n.officialstores.1001.dstorelist_1_2.1ad86780h80264&acm=20180501004&scm=1007.18128.100341.100200300000000',
        'https://www.lazada.vn/products/hcmtra-gop-0mainboard-asus-z590-rog-maximus-xiii-extreme-glacial-intel-i1319131294-s5226087280.html?spm=a2o4n.home.just4u.14.19946afejQP6RT&scm=1007.17519.162103.0&pvid=df2bb7fe-57c6-47a8-b946-da3ed41bcd35&search=0&clickTrackInfo=tcsceneid%3AHPJFY%3Bbuyernid%3A7ad5fd1a-d9f1-43de-e917-fa99f2b65de9%3Btcboost%3A0%3Bpvid%3Adf2bb7fe-57c6-47a8-b946-da3ed41bcd35%3Bchannel_id%3A0000%3Bmt%3Ai2i%3Bitem_id%3A1319131294%3Bself_ab_id%3A162103%3Bself_app_id%3A7519%3Blayer_buckets%3A5437.25236_955.3630_955.7330_6059.28889%3Bpos%3A14%3B'
        ]
    ...
    def parse(self, response):
        ...
        p_3star_rating = response.xpath('//div[@class="detail"]/ul[1]/li[3]/span[2]/text()').get()
        p_2star_rating = response.xpath('//div[@class="detail"]/ul[1]/li[4]/span[2]/text()').get()
        p_1star_rating = response.xpath('//div[@class="detail"]/ul[1]/li[5]/span[2]/text()').get()
        ...
        item["p_5star_rating"] = p_5star_rating
        item["p_4star_rating"] = p_4star_rating
        item["p_3star_rating"] = p_3star_rating
        item["p_2star_rating"] = p_2star_rating
        item["p_1star_rating"] = p_1star_rating 
        yield item